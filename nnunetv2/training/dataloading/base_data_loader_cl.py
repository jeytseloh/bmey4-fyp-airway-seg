...
class nnUNetDataLoaderBaseCL(DataLoader):
    def __init__(self,
                 data: nnUNetDatasetCL,
                 batch_size: int,
        ...
        assert isinstance(data, nnUNetDatasetCL), 'nnUNetDataLoaderBase only supports dictionaries as data'
        ...
        self.data_shape, self.seg_shape, self.cl_shape = self.determine_shapes() # added cl shape
    ...
    def determine_shapes(self):
        # load one case
        data, seg, properties, cl = self._data.load_case(self.indices[0])
        num_color_channels = data.shape[0]

        data_shape = (self.batch_size, num_color_channels, *self.patch_size)
        seg_shape = (self.batch_size, seg.shape[0], *self.patch_size)
        cl_shape = (self.batch_size, cl.shape[0], *self.patch_size) # centreline
        return data_shape, seg_shape, cl_shape
